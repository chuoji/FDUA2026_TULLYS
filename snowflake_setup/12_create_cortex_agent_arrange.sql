...
tools:
  ...
  - tool_spec:
      ...
      description: |
        都道府県×居住区分ごとの「住宅ストック・着工・居住水準・設備・都市機能」などの基礎指標を参照・分析するツール。
  ...
  - tool_spec:
      ...
      description: |
        都道府県×居住区分ごとの「住宅比率・居住水準・生活利便・都市計画・インフラ指標」を横断して参照・分析するツール。
  ...
  - tool_spec:
      ...
      description: |
        ...
        - 項目: 有価証券報告書内の項目（例: 経営方針、サステナビリティ、事業等のリスク、MD&A、研究開発活動）
